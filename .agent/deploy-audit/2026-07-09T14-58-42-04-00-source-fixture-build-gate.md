...
`tests/smoke.mjs` checks that the hot-air-balloon route, object kits, first-person basket view, burner animation, rope kit, panel kit, and Vite base are present.
