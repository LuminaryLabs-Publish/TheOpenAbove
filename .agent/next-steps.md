...
Create pure source/readback modules that make the current hot-air-balloon route the durable source of truth without changing the live renderer, balloon physics, camera, HUD, object-kit composition, or existing GameHost state fields.
